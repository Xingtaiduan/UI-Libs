...
do local GUI = game.CoreGui:FindFirstChild("Darkrai");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(5,199,5)
   end 
end
...
function DarkraiX:Window(text,gamenme)
    local hubname = text
    local gamename = gamenme or PlaceName
	local abc = false
	local currentpage = ""
	...
	Name.Text = hubname
	Name.TextColor3 = Color3.fromRGB(5,199,5)
	...
	Hub.Position = UDim2.new(0.12, 0, 0, 0)
	Hub.Size = UDim2.new(0, 81, 0, 27)
	Hub.Font = Enum.Font.GothamSemibold
	Hub.Text = "|  "..gamename
	Hub.TextColor3 = Color3.fromRGB(5,199,5)
	Hub.TextSize = 17.000
	...
	Close.Text = "×"
	Close.TextColor3 = Color3.fromRGB(5,199,5)
	...
	function uitab:Tab(text)
	    ...
	    TabButton.BorderColor3 = Color3.fromRGB(5,199,5)
