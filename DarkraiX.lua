...
do local GUI = game.CoreGui:FindFirstChild("Darkrai");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(0,238,255)
   end 
end
...
function DarkraiX:Window(text,gamenme,logo,keybind)
	...
	Name.Text = hubname
	Name.TextColor3 = Color3.fromRGB(0,238,255)
	...
	Hub.Text = "  | "..gamename
	Hub.TextColor3 = Color3.fromRGB(0,238,255)
	Hub.TextSize = 17.000
	...
	BindButton.TextColor3 = Color3.fromRGB(0,238,255)
	...
	function uitab:Tab(text)
	    ...
	    TabButton.BorderColor3 = Color3.fromRGB(0,238,255)
