...
--[[
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/IlIIIIIIIIIIIIIIIIllll/IIIlllllIIIIIIlllllllllllllllllllllllllllllllllllllllllIIllIIIlllllIIIIIIl/main/u.lua", true))()

local window = Library:new("云脚本制作")

local creds = window:Tab("主要的",'4483345998')
local Tab = creds:section("功能",true)
